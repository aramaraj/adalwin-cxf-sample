package com.adalwin.repository;
	...
	@Repository public class PersonRepository { 
		...
		public List<Person> getAllPersons() { 
			...
			logger.info("Total amount of persons: {}", results.size()); logger.info("Results: {}", results); 
			return results;
		...
		public void insertPersonWithNameJohnAndRandomAge() { 
			...
			Person p = new Person("Ashok", (int) age); mongoTemplate.insert(p); 
		} 
