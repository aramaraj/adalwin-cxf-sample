...
public class FutureDemoExecutor {
    ...
    public static int amountOfDivisibleByFuture(final int first, final int last, final int divisor)
        ...
        FutureTask<Integer> futureTask_1 = new FutureTask<Integer>(new Callable<Integer>(){
        	...
        	@Override
        	public Integer call(){
        		return FutureDemoExecutor.amountOfDivisibleBy(first, last/2, divisor);
        	}
        });
        
        
        list.add(futureTask_1);
        ...
        FutureTask<Integer> futureTask_2 = new FutureTask<Integer>(new Callable<Integer>() {
            @Override
            public Integer call() {
                return FutureDemoExecutor.amountOfDivisibleBy(last / 2 + 1, last, divisor);
            }
        });
        list.add(futureTask_2);
        executor.execute(futureTask_2);
 
        /*while(!futureTask_1.isDone() || !futureTask_2.isDone()){
        ...
        for (int j = 0; j < threadNum; j++) {
            FutureTask<Integer> futureTask = list.get(j);
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        int result = FutureDemoExecutor.amountOfDivisibleBy(0, MAX_NUMBER, 3);
        ...
        int resultFuture = FutureDemoExecutor.amountOfDivisibleByFuture(0, MAX_NUMBER, 3);
